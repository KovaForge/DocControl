...
def openclaw_manifest() -> dict[str, Any]:
    return {
        ...
        "versionCommand": None,
        "healthCommand": None,
        "bootstrapCommand": "Create an agent token in DocControl Settings and set DOCCONTROL_TOKEN, or run doccontrol login microsoft",
        "principles": [
            ...
            "Settings-generated agent tokens and minted DocControl bearer tokens stay outside the repo",
